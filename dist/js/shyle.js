...
},{"./components/modal":"7OemA","./components/tooltip":"ehjKj","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"7OemA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Modal {
    ...
    bindEvents() {
        ...
        if (this.closeButton && this.modal) this.closeButton.addEventListener("click", ()=>this.close());
        if (this.modal) window.addEventListener("click", (event)=>{
    ...
    open() {
        const SCOPE = "open";
        console.log(`[${TITLE}#${SCOPE}]`);
        if (this.modal) this.modal.classList.add("shyle-modal-open");
    }
    close() {
        const SCOPE = "close";
        console.log(`[${TITLE}#${SCOPE}]`);
        if (this.modal) this.modal.classList.remove("shyle-modal-open");
    }
}
