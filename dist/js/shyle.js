...
})({"fVEe2":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a4027d8ca618b7ea";
"use strict";
...
},{}],"6z6cM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _modal = require("./components/modal");
var _modalDefault = parcelHelpers.interopDefault(_modal);
var _tooltip = require("./components/tooltip");
var _tooltipDefault = parcelHelpers.interopDefault(_tooltip);
var _typography = require("./content/typography");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const tooltip = new (0, _tooltipDefault.default)({
        selector: "[data-shy-tooltip]"
    });
    console.log(`[${TITLE}#${SCOPE}] tooltip`, tooltip);
    const typography = new (0, _typographyDefault.default)({
...
},{"./components/modal":"7OemA","./components/tooltip":"ehjKj","./content/typography":"l1IUI","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"7OemA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Modal {
    ...
    bindEvents() {
        ...
        this.triggerElements.forEach((trigger)=>{
            ...
            if (modal) trigger.addEventListener("click", ()=>this.open(modal));
        });
        ...
        window.addEventListener("click", (event)=>{
            ...
            if (target.classList.contains("shy-modal")) this.close(target);
        });
    }
    // Open the modal
    open(modal) {
...
},{}],"ehjKj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const TITLE = "tooltip";
class Tooltip {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"l1IUI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Typography {
    ...
    updateCustomFontSize(element, inputValue) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["fVEe2","6z6cM"], "6z6cM", "parcelRequire19ed")
